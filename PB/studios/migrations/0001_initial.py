    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ImageField(null=True, upload_to='studios')),
            ],
        ),
        migrations.CreateModel(
            name='Classes',
            fields=[
                ...
                ('frequency', models.IntegerField(choices=[(3, 'Monthly'), (2, 'Weekly'), (1, 'Daily'), (0, 'Once')], null=True)),
                ('start_date', models.DateField(null=True)),
                ('start_time', models.CharField(max_length=120, null=True)),
                ('end_time', models.CharField(max_length=120, null=True)),
                ('cancelled_date', models.DateTimeField(blank=True, null=True)),
                ('enrolled', models.ManyToManyField(blank=True, related_name='users', to=settings.AUTH_USER_MODEL)),
